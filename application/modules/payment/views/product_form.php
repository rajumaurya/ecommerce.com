...
<head>
    ...
    <script type="text/javascript">
        ...
        Stripe.setPublishableKey('pk_test_51HoOyfLErnaPWmNjAtwOaWyjZzU6XnNWVXhwlEucN7bwuaSi3qVrEWZ24xnO45sDVYpSkf8FHXOVPOEZyOHCSfTQ007JGMSr2G');
                ...
                <div class="card-body bg-light">
                    ...
                    <div id="payment-errors"></div>  
                     <form method="post" id="paymentFrm" enctype="multipart/form-data" action="<?php echo base_url(); ?>payment/check">
                        ...
                        <div class="form-group">
                            <input type="email" name="email" class="form-control" placeholder="email@you.com" value="<?php echo $this->session->userdata('email'); ?>" required />
                        </div>
