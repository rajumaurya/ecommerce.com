                    ...
                    <div class="panel panel-default aa-checkout-login ">
                      ...
                      <div id="collapseTwo" class="panel-collapse collapse">
                        <div class="panel-body">
                          ...
                          <button type="submit" class="aa-browse-btn client_login">Login</button>
                      ...
                      <div id="collapseThree" class="panel-collapse collapse">
                        <div class="panel-body">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="aa-checkout-single-bill">
                                <textarea cols="8" name="address" id="address" rows="3">Address*</textarea>
                              </div>
                            </div>
                          </div>
                          <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="aa-checkout-single-bill">
                                <input type="text" name="appartment" id="appartment" placeholder="Appartment, Suite etc.">
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="aa-checkout-single-bill">
                        ...
                        <button type="submit" class="aa-browse-btn add_bill">submit</button>
                      </div>
                    </div>
                    <!-- Shipping Address -->
                    <div class="panel panel-default aa-checkout-billaddress">
              ...
              <div class="col-md-4">
                <div class="checkout-right">
                  ...
                  <div class="aa-order-summary-area">
                    <table class="table table-responsive order_details" >
                    <thead>
                    <tr>
                    <th>Item Name</th>
                    <th>Quantity</th>
